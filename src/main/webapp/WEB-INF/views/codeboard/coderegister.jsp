	...
	<div id="colorlib-main">
			 <article class="container" style="margin-top: 2%; margin-left:5%;" >
				  <div align="center"  class="card col-lg-12" style="margin-top: 5%;">
				    <form  action="coderegister?pageNum=${pageNum }" name="regform" style="margin-bottom: 5%; margin-top: 2%" method="post">
				      <h2><em>Codeboard write</em></h2>
				      <hr>
				      <table style= "width:80%;">
				        ...
				        <tr style="margin-bottom: 5%">
				          ...
				          <td colspan="2" align="center" style="margin-bottom: 5%">
				            ...
				            <input type="button" class="btn btn-primary" style="cursor: url(${pageContext.request.contextPath }/images/click.png) 8 0, pointer;" value="목록" onclick="location.href='codelist?pageNum=${pageNum}'">
				          </td>
				        </tr>
				      </table>
				    </form>
