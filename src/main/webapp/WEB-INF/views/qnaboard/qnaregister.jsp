	 ...
	 <div id="colorlib-main">
		  <article class="container" style="margin-top: 2%; margin-left:5%;" >
				  <div align="center"  class="card col-lg-12" style="margin-top: 5%;">
				    <form  action="qnaregister?pageNum=${pageNum }" name="regform" style="margin-bottom: 5%; margin-top: 2%" method="post">
				      <h2><em>Q&Aboard write</em></h2>
				      <hr>
				      <table style= "width:80%;">
				        ...
				        <tr>
				          <td style="color: black; font-weight: bolder;">
				          	글제목&nbsp;<input type="text" name="title" class="click" style="width: 90%;"></td>
				        </tr>
				        <tr>
				          <td style="color: black; font-weight: bolder;">
				            글내용<textarea rows="12" style="width:100%;" class="click" name="content">${dto.content}</textarea>
				          </td>
				        </tr>
				        <tr style="margin-bottom: 5%">
				          ...
				          <td colspan="2" align="center" style="margin-bottom: 5%">
				            ...
				            <input type="button" class="btn btn-primary" style="cursor: url(${pageContext.request.contextPath }/images/click.png) 8 0, pointer;" value="목록" onclick="location.href='qnalist?pageNum=${pageNum}'">
				          </td>
				        </tr>
				      </table>
				    </form>
