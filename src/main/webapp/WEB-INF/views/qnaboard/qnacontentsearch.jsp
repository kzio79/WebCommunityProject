   		 ...
   		 <article class="col-lg-6" style="margin-top: 2%; margin-left: 5%">       
        	 <div align="center">
                <h1 class="container"><em>QnA Board Content</em></h1>  
			 	...
			 	<!-- 글 등록 메뉴 -->		
			 		<div align="center"	>		
						<input type="button" value="검색목록" class="btn btn-primary" onclick="location.href='qnalistsearch?pageNum=${pageNum}&qnasearch=${qnasearch }'">
						<input type="button" value="수정" class="btn btn-primary" ${sessionScope.nickname != dto.writer ? 'hidden' : '' } ${dto.regdate < user_create ? 'hidden' : ''} onclick="location.href='qnamodify?pageNum=${pageNum }&qnum=${dto.qnum}'">					
					</div>
					<br>   
