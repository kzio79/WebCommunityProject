		 ...
		 <div id="colorlib-main">
			 <article class="container" style="margin-top: 2%; margin-left:5%;" >
				  <div align="center"  class="card col-lg-12" style="margin-top: 5%;">
				    <form  action="qnaupdate?pageNum=${pageNum}&qnum=${dto.qnum}" name="regform" style="margin-bottom: 5%; margin-top:2%;" method="post">
				      <h2><em>Q&Aboard modify</em></h2>
				      <hr>
				      <table style= "width:80%;">
				        <tr>
				           <td style="color: black; font-weight: bolder;">
				           	 글번호&nbsp;<input type="text" name="qnum"  value="${dto.qnum}" readonly></td>
				        </tr>
				        <tr>
				          <td style="color: black; font-weight: bolder;">
				        ...
				        <tr style="margin-bottom: 5%">
				          ...
				          <td colspan="2" align="center" style="margin-bottom: 5%">
				            ...
				            <button type="button" class="btn btn-primary" style="cursor: url(${pageContext.request.contextPath }/images/click.png) 8 0, pointer;" onclick="location.href='qnalist?pageNum=${pageNum}'">목록</button>
	 ...
	 <script>
 		...
 		function deleteCheck() {
			if(confirm("게시글을 삭제 하겠습니까?")){
				location.href="qnadelete?pageNum=${pageNum}&qnum=${dto.qnum}";
			}				
	 	}
	 </script>
	</body>
